...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Product.objects.bulk_create(products) # метод bulk_create принимает на вход список объектов и эти
        # объекты через 1 insert запрос добавляются в базу данных, вместо того, что бы добавлять продукты
        # по одному через save